...
function AR
load('C:\Users\Megan Kehoe\Documents\VIP\Patient Data\TA023\TA023_08aug2009_18_23_06_Seizure.mat');
CH1_5 = record_RMpt5(1:5,:);
start = 1;
stop = 1001;
CH1_5 = CH1_5(:,start:stop);
[Am,S,~,~]=idMVAR(CH1_5,5,0);
save AR.mat Am S
end
