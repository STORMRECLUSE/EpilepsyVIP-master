...
# need to insert path for this import to work
sys.path.insert(0, '/Users/stormrecluse/Desktop/Epilepsy 2018summer/DataInterfacing')
...
def choose_best_channels(patient_id):
    ...
    good_channel_dict = {'TS041': ['LAH2', 'LAH3', 'LAH4', 'LPH1', 'LPH2', 'LPH3', ],
                         ...
                         'TA510': ['LPH6', 'LPH7', 'LPH9', 'LPH10', 'LPH11', 'LPH12', ],
                         'TA511': ['LPH6', 'LPH7', 'LPH9', 'LPH10', 'LPH11', 'LPH12', ],
        ...
        if file_durations[just_name] >= min_per_chunk * sec_per_min and not (file_type[i] is 'ictal'):
            ...
            while True:
                ...
                try:
                    ...
                    X_chunk, _, labels = edfread(single_data_filename, rec_times=[start, end],
...
def offline_training(feat, cv_file_type, cv_seizure_times, cv_train_files, win_len, win_overlap, f_s, freq_band,
                     ...
                     calc_params_local, features_path):
...
########################################################## ON LINE TRAINING BLOCK ##########################################################

# construct_coherency_matrix is in OFF LINE TRAINING BLOCK
...
# find_katz is in OFF LINE TRAINING BLOCK
...
def parent_function():
    ...
    patients = ['TA023']  # set which patients you want to test
    ...
    persistence_time = 3.2 * 60  # minutes times seconds, the amount of time after a seizure prediction for which no alarm is raised
    ...
    for patient_index, patient_id in enumerate(patients):
        ...
        all_files, data_filenames, file_type, seizure_times = analyze_patient_raw(p_data_path, f_s, include_awake, include_asleep, patient_id, win_len, win_overlap, calc_train_features_locally)
        ...
        for feature in feats:
            for freq in freq_bands:
                ...
                for i in xrange(number_files):
                    ...
                    svm, mean_mat, std_mat, threshold, adapt_rate, traindat, num_supp_vec, dim_supp_vec, supp_vecs, gamma, dual_coeff, intercept = offline_training(feat, cv_file_type, cv_seizure_times, cv_train_files, win_len, win_overlap, f_s, freq_band, i, patient_id, persistence_time, preictal_time, postictal_time, calc_train_features_locally, calc_train_params_locally, p_features_path)
